...
#plot2 weekdays by Global active power between dates 2007-02-01 and 2007-02-02
png(file="plot2.png", height=480, width=480, units="px")
plot(setdat$Time, setdat$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")
dev.off()
